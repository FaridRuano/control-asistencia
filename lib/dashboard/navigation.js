  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Plan semanal",
        description: "Ajustes semanales y continuidad",
      },
      {
      ...
      },
      {
        ...
        description: "Ausencias programadas y solicitudes",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        label: "Horarios base",
        description: "Plantillas por rol",
      },
      {
      ...
      },
      {
        ...
        description: "Horas, descansos y recargos",
      },
      {
        href: planningModulePath("/settings/budget"),
        label: "Parámetros de presupuesto",
        description: "Topes y costos operativos",
      },
      {
