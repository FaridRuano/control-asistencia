...
export const OPERATIONAL_ROLES = [
  ...
  { code: "VENDALM", name: "VENDEDOR", areaCode: "ALM", description: "Atencion y venta general de almacen." },
  { code: "VENFER", name: "VENDEDOR FERRETERO", areaCode: "ALM", description: "Venta y cobertura especializada de ferreteria." },
  { code: "VENHOG", name: "VENDEDOR HOGAR", areaCode: "ALM", description: "Venta y cobertura especializada de hogar." },
  { code: "VENACA", name: "VENDEDOR ACABADOS", areaCode: "ALM", description: "Venta y cobertura especializada de acabados." },
